...
package extensions.starling {
	...
	public class customButton extends DisplayObjectContainer {
		...
		public function customButton(upState:Texture, text:String = "", id:String = "", downState:Texture = null, overState:Texture = null, overlay:Texture = null) {
			if (upState == null)
		...
		private function onTouch(event:TouchEvent):void {
			...
			if (touch.phase == TouchPhase.HOVER && !mIsDown) {
